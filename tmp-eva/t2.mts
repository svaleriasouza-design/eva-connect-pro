...
const r = await generateText({ model: gw("google/gemini-3.6-flash"), system:"Você é a EVA. Use ferramentas.", tools, stopWhen: stepCountIs(6), messages:[{role:"user",content:"Quantas empresas foram contatadas?"}]});
